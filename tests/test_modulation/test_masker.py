...
class TestPowerSpectrum:
    ...
    def test_power_spectrum_db_scale(
        ...
        """1 kHz 사인파의 파워가 1 kHz bin 근처에서 peak."""
    ...
    def test_power_spectrum_silence_low(
        ...
        """무음 입력은 매우 낮은 dB (epsilon 처리 확인)."""
        power = masker.compute_power_spectrum(audio_silence)
        # 모든 값이 매우 낮음 (-100 dB 이하)
...
# ----------------------------------------------------------------------
# Stage 4: Simultaneous Masking (skip 유지)
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# Stage 5: Final Threshold (skip 유지)
# ----------------------------------------------------------------------
