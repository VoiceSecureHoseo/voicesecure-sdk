...
class TTSEvaluator(Evaluator):
    ...
    def evaluate(self, original: AudioArray, modified: AudioArray) -> EvaluatorOutput:
        ...
        clone_ov2 = self.synthesize_clone(
            self._openvoice_model, modified, model_name="OpenVoice2"
        )
        ...
        openvoice_dist = cosine_distance(original_features["original_embedding"], clone_ov2_embedding)
